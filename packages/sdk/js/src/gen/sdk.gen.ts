...
import type {
  ...
  GitCommitResponses,
  GitDeleteUntrackedResponses,
  GitDiffResponses,
  GitDiscardResponses,
  GitLogResponses,
  GitShowResponses,
  GitStageAllResponses,
  GitStageResponses,
  GitStatusResponses,
  GitUnstageAllResponses,
  GitUnstageResponses,
  ...
  LspDocumentChangeErrors,
  LspDocumentChangeResponses,
  LspDocumentCloseErrors,
  LspDocumentCloseResponses,
  LspDocumentOpenErrors,
  LspDocumentOpenResponses,
  LspDocumentSaveErrors,
  LspDocumentSaveResponses,
  LspHoverErrors,
  LspHoverResponses,
  LspStatusResponses,
  McpAddErrors,
    ...
    parameters: {
      ...
      parts?: Array<
        ...
        | {
            ...
            path: string
            mime?: string
            [key: string]: unknown | "file" | string | undefined
          }
        | {
            type: "agent"
...
export class Git extends HeyApiClient {
   ...
   */
  public deleteUntracked<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
      files?: Array<string>
    },
    ...
    return (options?.client ?? this.client).post<GitDeleteUntrackedResponses, unknown, ThrowOnError>({
   ...
   *
   * Get file content from a specific git ref (HEAD, index, or commit).
   */
  public show<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<GitShowResponses, unknown, ThrowOnError>({
      url: "/git/show",
      ...options,
      ...params,
    })
