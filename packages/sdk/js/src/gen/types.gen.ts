...
export type Part = TextPart | {
    ...
    agent: string;
    command?: string;
} | ReasoningPart | RedactedReasoningPart | FilePart | ToolPart | StepStartPart | StepFinishPart | SnapshotPart | PatchPart | AgentPart | RetryPart | CompactionPart;
        ...
        all: Array<{
            ...
            models: {
                [key: string]: {
                    ...
                    [key: string]: unknown | string | 'active' | 'deprecated' | {
                        input: number;
                        output: number;
                        [key: string]: unknown | number;
                    } | {
