...
export class Config extends HeyApiClient {
     ...
     */
    public models<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
    }, options?: Options<never, ThrowOnError>) {
        const params = buildClientParams([parameters], [{ args: [{ in: 'query', key: 'directory' }] }]);
...
export class Worktree extends HeyApiClient {
    ...
    public create<ThrowOnError extends boolean = false>(parameters?: {
        ...
        const params = buildClientParams([parameters], [{ args: [{ in: 'query', key: 'directory' }, { key: 'worktreeCreateInput', map: 'body' }] }]);
...
export class Plan extends HeyApiClient {
     ...
     */
    public approve<ThrowOnError extends boolean = false>(parameters: {
        requestID: string;
        directory?: string;
    }, options?: Options<never, ThrowOnError>) {
        const params = buildClientParams([parameters], [{ args: [{ in: 'path', key: 'requestID' }, { in: 'query', key: 'directory' }] }]);
...
export class App extends HeyApiClient {
     ...
     */
    public permissionModes<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
    }, options?: Options<never, ThrowOnError>) {
        const params = buildClientParams([parameters], [{ args: [{ in: 'query', key: 'directory' }] }]);
