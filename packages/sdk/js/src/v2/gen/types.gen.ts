...
export type PlanRequest = {
  ...
  sessionID: string
  /**
   * The tool_use_id of the ExitPlanMode call
   */
  callID: string
  /**
...
export type McpRemoteConfig = {
  ...
  /**
   * Transport type for the remote server. Defaults to 'sse' if not specified.
   */
  transport?: "http" | "sse"
  /**
...
export type ConfigModelsResponses = {
  /**
   * List of models
   */
  200: {
...
export type ConfigModelsResponse = ConfigModelsResponses[keyof ConfigModelsResponses]
...
export type GitShowData = {
  ...
  query: {
    ...
    file: string
    /**
     * Git ref: HEAD, : (for staged), or commit hash
     */
    ref?: string
  }
  url: "/git/show"
...
export type GitShowResponse = GitShowResponses[keyof GitShowResponses]
