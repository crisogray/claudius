...
import type { Plugin } from "@claudius.to/plugin"
...
import { type Plugin, tool } from "@claudius.to/plugin"
...
Levels: `debug`, `info`, `warn`, `error`. See [SDK documentation](https://claudius.to/docs/sdk) for details.
