...
The model ID in your OpenCode config uses the format `provider/model-id`. For example, `anthropic/claude-sonnet-4` for Claude Sonnet 4.
...
:::tip
Do you have an agent you'd like to share? [Submit a PR](https://github.com/crisogray/claudius).
:::
