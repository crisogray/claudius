...
- **Using Mise**
  ...
  ```bash
  mise use -g github:crisogray/claudius
  ```

- **Using Docker**

  ```bash
  docker run -it --rm ghcr.io/crisogray/claudius
  ```

Support for installing OpenCode on Windows using Bun is currently in progress.

You can also grab the binary from the [Releases](https://github.com/crisogray/claudius/releases).
...
1. Run the `/connect` command in the TUI and select a provider.

   ```txt
   /connect
   ```

2. Follow the prompts to authenticate or enter your API key.
